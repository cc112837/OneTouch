...
//		}
//		dialog.setTitle("saomiaojie");
//		dialog.setMessage(obj.getText());
//		dialog.setNegativeButton("queding", new DialogInterface.OnClickListener()
//		{
//			@Override
...
//			}
//		});
//		dialog.setPositiveButton("quxiao", new DialogInterface.OnClickListener()
//		{
//			@Override
//			public void onClick(DialogInterface dialog, int which)
//			{
...
//	}
	public void handleDecode(final Result obj, Bitmap barcode)
	{
		inactivityTimer.onActivity();
		playBeepSoundAndVibrate();
		String result =obj.getText();//二维码的扫描结果
		Intent intent = new Intent();
