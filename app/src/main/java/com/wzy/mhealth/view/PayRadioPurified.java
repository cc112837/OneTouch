...
public class PayRadioPurified extends RelativeLayout implements Checkable {
    ...
    private ImageView payLogo, iv_visi;
    private TextView payTitle;
    private TextView payDesc;
    private RadioButton payChecked;

    private boolean mChecked, mvisi;
    ...
    public PayRadioPurified(Context context, AttributeSet attrs) {
        ...
        iv_visi = (ImageView) findViewById(R.id.iv_visi);
        ...
        boolean visi = array.getBoolean(R.styleable.PayRidioButton_visi, false);
        if (visi)
            iv_visi.setVisibility(VISIBLE);
        else iv_visi.setVisibility(GONE);
