...
public class PayRadioButton extends Button implements Checkable{
	...
	public void setChecked(boolean checked) {
		// TODO Auto-generated method stub		//鎵ц鍒拌繖锛屽洜涓虹涓�涓槸娌℃湁閫変腑鐨勶紝鎵�浠ユ病鐭ラ亾杩欓噷锛屼絾鏄浜屼釜锛岄粯璁ゆ槸閫変腑鐨勶紝鎵ц浜嗗畠
		//褰撴墽琛屼簡鐐瑰嚮浜嬩欢
		if (mChecked != checked) {
            mChecked = checked;
            ...
            if (mOnCheckedChangeListener != null) {
            	System.out.println(">>>25");		//鐐瑰嚮浜嗕篃娌℃湁鎵ц�?
                mOnCheckedChangeListener.onCheckedChanged(this, mChecked);
            }
            if (mOnCheckedChangeWidgetListener != null) {
            	System.out.println(">>>27");		//鐐瑰嚮鍚庢墽琛屼�?
                mOnCheckedChangeWidgetListener.onCheckedChanged(this, mChecked);
            }
            mBroadcasting = false;		//杩欓噷閮芥槸鏈�鍚庢墽琛�?殑銆�?  
        }
	}
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (buttonDrawable != null) {
            ...
            x = getWidth() - width;		//寰楀埌鍏朵笌宸﹁竟鐨勯棿璺�
