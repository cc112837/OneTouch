 ...
 */
public class HealthListFragment4 extends Fragment implements XListView.IXListViewListener {
    ...
    private void init(View v) {
        ...
        page=1;
        String url = "http://api.m.vodjk.com/v1/content?channelid=35&height=210.9375&ip=192.168.1.107&modules=flow%3A1%2Cslider%3A1&page="+page+"&pagesize=20&sign=d2397d89e14070110eba3d4c3c46b40f&time=1408764433&token=3&type=android&width=375";
