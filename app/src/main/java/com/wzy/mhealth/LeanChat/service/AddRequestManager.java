package com.wzy.mhealth.LeanChat.service;
...
import com.wzy.mhealth.LeanChat.util.SimpleNetTask;
...
public class AddRequestManager {
  ...
  private void createAddRequest(LeanchatUser toUser) throws Exception {
    ...
    if (count > 0) {
      // 抛出异常，然后提示用户
      throw new IllegalStateException(MyApplication.getInstance().getString(R.string.contact_alreadyCreateAddRequest));
    } else {
